  ...
  try {
    ...
    const formattedEmployees = await Promise.all(employees.map(async (emp) => {
      ...
      return {
        ...
        complexityAllowance: emp.complexityAllowance || 0,
        observationalAllowance: emp.observationalAllowance || 0,
        foodAllowance: emp.foodAllowance || 0,
        transportationAllowance: emp.transportationAllowance || 0,
        communicationsAllowance: emp.communicationsAllowance || 0,
        internetAllowance: emp.internetAllowance || 0,
        riceSubsidyAllowance: emp.riceSubsidyAllowance || 0,
        clothingAllowance: emp.clothingAllowance || 0,
        laundryAllowance: emp.laundryAllowance || 0,
        allowance: emp.allowance || 0,
        kpiOtIncentive: emp.kpiOtIncentive || 0,
        salaryAdjustmentDefault: emp.salaryAdjustmentDefault || 0,
...
router.get('/:id', verifyAdminToken, async (req, res) => {
  try {
    ...
    const formattedEmployee = {
      ...
      complexityAllowance: employee.complexityAllowance || 0,
      observationalAllowance: employee.observationalAllowance || 0,
      foodAllowance: employee.foodAllowance || 0,
      transportationAllowance: employee.transportationAllowance || 0,
      communicationsAllowance: employee.communicationsAllowance || 0,
      internetAllowance: employee.internetAllowance || 0,
      riceSubsidyAllowance: employee.riceSubsidyAllowance || 0,
      clothingAllowance: employee.clothingAllowance || 0,
      laundryAllowance: employee.laundryAllowance || 0,
      allowance: employee.allowance || 0,
      kpiOtIncentive: employee.kpiOtIncentive || 0,
      salaryAdjustmentDefault: employee.salaryAdjustmentDefault || 0,
